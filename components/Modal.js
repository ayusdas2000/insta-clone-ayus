...
function Modal() {
  ...
  const uploadPost = async () => {
    ...
    // 4) get a download URL for fb storage and update the original post with image
      ...
      >
        <div className="flex min-h-[800px] items-end justify-center px-4 pt-4 pb-20 text-center sm:block sm:min-h-screen sm:p-0">
          <Transition.Child
            ...
            leaveTo="opacity-0"
          >
            <Dialog.Overlay className="transaction-opacity fixed inset-0 bg-gray-500 bg-opacity-75" />
          </Transition.Child>
          <span
          ...
          >
            <div className="pb4 inline-block transform overflow-hidden rounded-lg bg-white px-4 pt-5 text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6 sm:align-middle">
              <div>
                <div>
                  {selectedFile ? (
                    <img
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="mt-2">
                      <input
                        ...
                        type="text"
                        ref={captionRef}
                        placeholder="Pleae enter a caption"
                      />
                    </div>
                  </div>
                </div>
